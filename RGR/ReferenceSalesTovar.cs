...
namespace RGR
{
    public partial class ReferenceSalesTovar : Form
    {
        MainForm mainForm;
        public ReferenceSalesTovar()
        {
            InitializeComponent();
        }
        public ReferenceSalesTovar(MainForm main)
        {
            InitializeComponent();
            mainForm = main;
            addDataComboBox();
        ...
        {
            string comand = "SELECT * FROM Товары ORDER BY ИдентификаторТовара;";
            DataTable dt = new DataTable();
            dt = mainForm.GetData(comand);
            dt.Columns.Add("ТоварНомер", typeof(string), "Название +  '(' + НомерТовара + ')'");
            comboBox1.DataSource = dt;
            comboBox1.DisplayMember = "ТоварНомер";
        ...
        private void buttonAccept_Click(object sender, EventArgs e)
        {
            if (comboBox1.SelectedItem != null)
            {
                ...
                string comand = "SELECT * FROM Справка_о_продажах_товара(" + comboBox1.SelectedValue.ToString() + ");";
                DataTable dt = new DataTable();
                dt = mainForm.GetData(comand);
        ...
        public class DataGridViewPrinter
        {
            ...
            private void PrintPage(object sender, PrintPageEventArgs e)
            {
                ...
                // Печать заголовка
                string header = "Справка о продажах товара " + selTable;
