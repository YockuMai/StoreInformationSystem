...
namespace RGR
{
    public partial class ReferenceCountTovar : Form
    {
        MainForm mainForm;
        public ReferenceCountTovar()
        {
            InitializeComponent();
        }
        public ReferenceCountTovar(MainForm mainForm)
        {
            InitializeComponent();
        ...
        private void buttonAccept_Click(object sender, EventArgs e)
        {
            if (comboBox1.SelectedItem != null)
            {
                ...
                string comand = "SELECT * FROM Справка_о_количестве_товара(" + comboBox1.SelectedValue.ToString() + ");";
                DataTable dt = new DataTable();
                dt = mainForm.GetData(comand);
        ...
        public class DataGridViewPrinter
        {
            ...
            private void PrintPage(object sender, PrintPageEventArgs e)
            {
                ...
                // Печать заголовка
                string header = "Справка о количестве товара " + selTable;
